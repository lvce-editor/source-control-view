...
export const MessageEnterToCommit = 'Message (Enter) to commit'
export const MessageEnterToCommitOnBranch = "Message (Enter) to commit on '{PH1}'"
...
export const NoWorkspaceOpen = 'No workspace is open.'
