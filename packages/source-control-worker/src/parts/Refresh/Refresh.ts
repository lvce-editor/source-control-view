...
export const refresh = async (state: SourceControlState): Promise<SourceControlState> => {
  const { actionsCache, enabledProviderIds, fileIconCache, height, iconDefinitions, itemHeight, minimumSliderSize, splitButtonEnabled, root, assetDir, platform } = state
