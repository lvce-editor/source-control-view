...
export const openChanges = (): string => {
...
export const discardAll = (): string => {
  return I18nString.i18nString(UiStrings.DiscardAll)
}

export const stageAll = (): string => {
...
export const unstageAll = (): string => {
  return I18nString.i18nString(UiStrings.UnstageAll)
}

export const unstage = (): string => {
...
export const commitAndPush = (): string => {
