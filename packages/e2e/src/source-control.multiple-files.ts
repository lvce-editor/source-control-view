...
export const test: Test = async ({ expect, Extension, FileSystem, Locator, SourceControl, Workspace }) => {
  ...
  const changesGroupsWithPaddingClasses = Locator('.SourceControlItems .TreeItem.Indent-4.IndentRight-12')
  ...
  await expect(changesGroup).toHaveCSS('padding-left', '4px')
  await expect(firstFile).toHaveCSS('padding-left', '16px')
