...
const packageJson = await readJson(join(root, 'packages', 'source-control-worker', 'package.json'))
...
await cp(join(root, 'packages', 'source-control-worker', 'settings.json'), join(dist, 'dist', 'settings.json'))
